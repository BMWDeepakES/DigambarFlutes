...
public class TransactionsController {
	...
	final String razorPayKeyId="rzp_test_B26a2I5GHszBwX";//rzp_test_LoErzylO1crkHT
	
	final String razorPaySecretKey="7Wk8fp6ozQI8JvS93wFotg8W";//i5dbKjdLu7L5gn5AJbJOGq8I
	...
	public ResponseEntity<String> initiatePayement(@RequestParam("amount")Long amount,@RequestParam("currency")String currency) throws JsonProcessingException {
		...
		String id=order.get("id");
		 ...
		 jsonobjectFormat.setMessage("transaction initiated  succeefully");
